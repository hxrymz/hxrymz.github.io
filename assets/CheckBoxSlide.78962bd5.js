import{r as n,j as l,F as s,a as e}from"./index.bb8b615c.js";const d=t=>{const[o,a]=n.exports.useState(!1),[i,r]=n.exports.useState(!1),c=b(t.keyCode);n.exports.useEffect(()=>{i||(a(t.initvalue),r(!0)),t.initvalue!==o&&a(t.initvalue)});const g=()=>{t.disabled||(typeof t.updChange=="function"&&t.updChange(!o),a(!o))};return l(s,{children:[l("div",{className:`toggle-container ptoggle-button_${t.keyCode} ${o?"_active":""}`,onClick:()=>g(),children:[e("div",{className:`toggle-bar ptoggle-button_${t.keyCode}`}),l("div",{className:`toggle-button ptoggle-button_${t.keyCode}`,children:[e("div",{className:"pripple",style:{opacity:.00448}}),e("div",{className:"pripple"})]}),e("div",{className:`toggle-label ptoggle-button_${t.keyCode}`})]}),e("style",{children:c})]})},b=t=>`
